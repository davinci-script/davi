...
func TestParseExpression(t *testing.T) {
	tests := []struct {
		...
		{"function() {}", "FunctionExpression", "function() {}", 1, 1},
		{"function(a) {}", "FunctionExpression", "function(a) {}", 1, 1},
		{"function(a,) {}", "FunctionExpression", "function(a) {}", 1, 1},
		{"function(a...) {}", "FunctionExpression", "function(a...) {}", 1, 1},
		{"function(a, b) {}", "FunctionExpression", "function(a, b) {}", 1, 1},
		{"function(a, b...) {}", "FunctionExpression", "function(a, b...) {}", 1, 1},
		{"function(a, b...,) {}", "FunctionExpression", "function(a, b...) {}", 1, 1},
		{"function(a, b,) {}", "FunctionExpression", "function(a, b) {}", 1, 1},
		{"function(a, b,) { return 0 }", "FunctionExpression", "function(a, b) {\n    return 0\n}", 1, 1},
		{"function(a: b) {}", "", "expected , between parameters", 1, 7},
		{"function(a..., b) {}", "", "can only have ... after last parameter", 1, 12},
		{"function(,) {}", "", "expected name and not ,", 1, 6},
		{"function(", "", "expected ) and not EOF", 1, 6},
...
if b {
    ...
    return inner
		...
		{"function f(a) {}", "function f(a) {}", 1, 1},
		{"function f(a,) {}", "function f(a) {}", 1, 1},
		{"function f(a...) {}", "function f(a...) {}", 1, 1},
		{"function f(a, b) {}", "function f(a, b) {}", 1, 1},
		{"function f(a, b...) {}", "function f(a, b...) {}", 1, 1},
		{"function f(a, b...,) {}", "function f(a, b...) {}", 1, 1},
		{"function f(a, b,) {}", "function f(a, b) {}", 1, 1},
		{"function f(a, b,) { return 0 }", "function f(a, b) {\n    return 0\n}", 1, 1},
		{"function f(a: b) {}", "expected , between parameters", 1, 9},
		{"function f(a..., b) {}", "can only have ... after last parameter", 1, 14},
		{"function f(,) {}", "expected name and not ,", 1, 8},
		{"function f(", "expected ) and not EOF", 1, 8},
